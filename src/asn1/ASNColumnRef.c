...
static asn_TYPE_member_t asn_MBR_ASNColumnRef_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASNColumnRef, fields),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_ASNColumnRefList,
...
static ber_tlv_tag_t asn_DEF_ASNColumnRef_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
...
static asn_SEQUENCE_specifics_t asn_SPC_ASNColumnRef_specs_1 = {
	...
	offsetof(struct ASNColumnRef, _asn_ctx),
	asn_MAP_ASNColumnRef_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_ASNColumnRef = {
	"ASNColumnRef",
	"ASNColumnRef",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_ASNColumnRef_tags_1,
	sizeof(asn_DEF_ASNColumnRef_tags_1)
		/sizeof(asn_DEF_ASNColumnRef_tags_1[0]), /* 1 */
	asn_DEF_ASNColumnRef_tags_1,	/* Same as above */
	sizeof(asn_DEF_ASNColumnRef_tags_1)
		/sizeof(asn_DEF_ASNColumnRef_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
